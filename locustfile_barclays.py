...
from locust_config import check_suite_whitelist, repeat_task, load_secrets, AUTOLINK, MEMBERSHIP_PLANS
...
class UserBehavior(SequentialTaskSet):
    ...
    def post_service(self):
        ...
        self.client.post("/service", json=self.consent, headers=self.single_prop_header,
    ...
    def post_membership_card_add_auth(self, plan_id):
        ...
        resp = self.client.post("/membership_cards", params=AUTOLINK, json=add_json, headers=self.single_prop_header,
    ...
    def post_membership_cards_enrol(self, plan_id):
        ...
        resp = self.client.post("/membership_cards", json=enrol_json, headers=self.single_prop_header,
                                name="LC005 - Register loyalty card")
    ...
    def post_and_patch_membership_cards_register(self, plan_id):
        ...
        resp = self.client.post("/membership_cards", params=AUTOLINK, json=ghost_card_add_json,
        ...
        self.client.patch(f"/membership_card/{mcard_id}", json=register_json, headers=self.single_prop_header,
                          name="LC005 - Register loyalty card")
    ...
    def post_membership_cards(self):
        ...
        if journey == MembershipCardJourney.ADD:
            ...
            raise RuntimeError(f"Invalid journey: {journey}, passed into to POST membership card test, "
    ...
    def get_membership_cards(self):
        ...
        self.client.get("/membership_cards", params=mcard_filters, headers=self.single_prop_header,
