...
HISTORY_DB_USER = env_var("HISTORY_USER", "postgres")
HISTORY_DB_PASSWORD = env_var("HISTORY_PASSWORD", "")
HISTORY_DB_HOST = env_var("HISTORY_HOST", "127.0.0.1")
HISTORY_DB_PORT = env_var("HISTORY_PORT", "5432")
