...
def membership_plan(scheme_id: int, name: str, slug: str) -> list:
    return [
        scheme_id,  # id
        name,  # name
        slug,  # slug
...
def card_no_question(question_id: int, scheme_id: int) -> list:
    return [
        question_id,  # id
        "Card Number",  # label
        scheme_id,  # scheme id
...
def password_question(question_id: int, scheme_id: int) -> list:
    return [
        question_id,  # id
        "Password",  # label
        scheme_id,  # scheme_id
...
def merchant_identifier_question(question_id: int, scheme_id: int) -> list:
    return [
        question_id,  # id
...
def first_name_question(question_id: int, scheme_id: int) -> list:
    return [
        question_id,  # id
        "First name",  # label
        scheme_id,  # scheme_id
...
def scheme_consent(pk: int, scheme_id: int) -> list:
    return [
        pk,  # id
        True,  # check box
...
def third_party_consent_link(pk: int, client_app_id: str, scheme_id: int, scheme_consent_id: int) -> list:
    return [
        pk,  # id
...
def create_all_third_party_consent_links(static_id: int, consent_id: int) -> list:
...
def scheme_image(pk: int, scheme_id: int) -> list:
    return [
        pk,  # id
...
def scheme_balance_details(pk: int, scheme_id: int) -> list:
    return [
        pk,  # id
        "points",  # currency
        "",  # prefix
...
def scheme_fee(pk: int, scheme_id: int) -> list:
    return [
        pk,  # id
...
def scheme_content(pk: int, scheme_id: int) -> list:
    return [
        pk,  # id
...
def membership_plan_documents(pk: int, scheme_id: int) -> list:
    return [
        pk,  # id
...
def voucher_scheme(pk: int, scheme_id: int) -> list:
    return [
        pk,  # id
        "GBP",  # earn_currency
        "£",  # earn_prefix
